...
#'   \item \code{\link{get_cr_outline}} — programmatic version with options.
#'   \item \code{\link{get_h3_grid}} — generate H3 hexagonal grid over this AOI.
#' }
#'
#' @examples
#' data(cr_outline_c)
...
#' \code{\link{cr_outline_c}} for mainland ecological analyses where oceanic
