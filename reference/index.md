...
- [`create_cat_esa_10m()`](https://manuelspinola.github.io/paisaje/reference/create_cat_esa_10m.md)
  : Create Categorical Land Cover Raster from Copernicus ESA WorldCover
  Data
...
- [`get_chelsa_future()`](https://manuelspinola.github.io/paisaje/reference/get_chelsa_future.md)
  : Download and Process Future Climate Variables from CHELSA v2.1
  (CMIP6)
...
- [`get_worldclim_future()`](https://manuelspinola.github.io/paisaje/reference/get_worldclim_future.md)
  : Download and process future environmental variables from WorldClim
  v2.1
- [`get_worldclim_historic()`](https://manuelspinola.github.io/paisaje/reference/get_worldclim_historic.md)
  : Descargar y procesar variables climáticas históricas de WorldClim
  v2.1
